...
katana requires Go 1.18 to install successfully. To install, just run the below command or download pre-compiled binary from release [page](https://github.com/byt3n33dl3/thc-KatanaX/releases).
...
```sh
docker pull byt3n33dl3/thc-KatanaX:latest
```
...
```sh
docker run byt3n33dl3/thc-KatanaX:latest -u https://tesla.com
```

> To run katana in headless mode using docker -

```sh
docker run byt3n33dl3/thc-KatanaX:latest -u https://tesla.com -system-chrome -headless
```
...
```sh
go install github.com/byt3n33dl3/thc-KatanaX/cmd/katana@latest
```
